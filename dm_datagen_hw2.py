...
def genlabel(atr):
    ...
    if atr[0]>3 and atr[1]>25:
        label = 0
    elif atr[0]>1 and atr[1]>30:
        label = 0
    elif atr[6]==1:
        label = 0
...
#        label = 0
    elif atr[8]==1 and atr[9]==1: #and atr[0]>2:
        label = 0
...
if __name__=="__main__":
    ...
    df.to_csv("sandwich_data.csv", header=None, index=None)
    df_test.to_csv("sandwich_test.csv", header=None, index=None)